  ...
  <div class="user-profile screen-center">
    <div class="user-profile-frame flex-row">
      <div class="user-profile-frame-left flex-col">
        ...
        <img v-else :src="require('/home/alperdogan/Desktop/projects/project/server/public/' + userData.profileImage)" />
        <input type="file" ref="file" @change="onSelect" accept="image/png, image/jpeg, image/jpg"/>
  ...
  methods: {
    ...
    async sendFile() {
      ...
      try {
        ...
        this.userData.profileImage = response.data.userImage;
      } catch (err) {
        console.log(err);
      }
    },
